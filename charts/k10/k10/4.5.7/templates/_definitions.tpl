...
{{- define "k10.restServices" -}}admin auth bloblifecyclemanager catalog crypto dashboardbff executor jobs logging metering state vbrintegrationapi {{- end -}}
{{- define "k10.services" -}}aggregatedapis config {{- end -}}
{{- define "k10.exposedServices" -}}auth dashboardbff vbrintegrationapi {{- end -}}
{{- define "k10.statelessServices" -}}admin aggregatedapis auth bloblifecyclemanager crypto dashboardbff executor state vbrintegrationapi {{- end -}}
